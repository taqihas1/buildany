...
const HERMES_URL = process.env.HERMES_URL || "http://localhost:8642/v1/chat/completions";
    ...
    case "buildany_create_project": {
      ...
      try {
        await db.insert(projects).values({
          id: projectId,
          userId: "system", // Kelly-created projects use "system" user
          name: projectName,
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Call Hermes/DeepSeek with tools
