        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            <>
              ...
              <Link href="/settings" className="text-gray-400 hover:text-gray-900 transition-colors">
            ...
            <>
              <SignInButton mode="modal">
                <button className="text-sm text-gray-500 hover:text-gray-900 transition-colors">Sign In</button>
              </SignInButton>
